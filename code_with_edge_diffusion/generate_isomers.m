...
% of the code
basedir = '../catalog/with_edge_diffusion/';
...
for j=pore_size_list
    ...
    for i=(num_isomers_done+1):Niso
        ...
        [tf,tknock_timeseries,num_dangling_bonds_timeseries,num_dangling_bonds_CH_timeseries,num_dangling_bonds_CH2_timeseries,num_AC,num_ZZ,num_UA,num_5R]=kmc_isomers_edge_diffusion(i,j,basedir);
